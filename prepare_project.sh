...
prepare_project() {
  ...
  chmod +x ./Snare_Lab_POC/create_venv.sh
  chmod +x ./Snare_Lab_POC/Setup/update_system_and_install_dependencies.sh
  chmod +x ./Snare_Lab_POC/Setup/configure_user_and_replace_placeholders.sh
  chmod +x ./Snare_Lab_POC/Setup/download_iso_files.sh
  chmod +x ./Snare_Lab_POC/Setup/download_snare_files.sh
  chmod +x ./Snare_Lab_POC/Setup/install_automation_tools.sh
  chmod +x ./Snare_Lab_POC/Setup/reassemble_iso_files.sh
  chmod +x ./Snare_Lab_POC/Setup/upload_iso.sh
