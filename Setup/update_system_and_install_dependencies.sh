...
update_system_and_install_dependencies() {
  ...
  sudo apt install -y git gpg nano tmux curl lsb-release gnupg jq p7zip-full sshpass software-properties-common mkisofs python3-venv python3 python3-pip unzip mono-complete coreutils || error_exit "Failed to install required packages."
