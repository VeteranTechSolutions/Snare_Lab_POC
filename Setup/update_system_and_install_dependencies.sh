...
update_system_and_install_dependencies() {
  ...
  sudo apt install -y git gpg nano tmux curl gnupg sshpass software-properties-common mkisofs python3-venv python3 python3-pip unzip mono-complete coreutils || error_exit "Failed to install required packages."
